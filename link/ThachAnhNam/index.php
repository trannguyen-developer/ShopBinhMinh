...
?>
            ...
            <li><a href="#">Sản phẩm</a>
                <ul class="menucon">
                    <li><a href="#">Đồng hồ nam</a>
                        <ul class="menuchau">
                            <li><a href="index.php">Đồng hồ thạch anh</a></li>
    ...
    <div id="content">
        <div id="rolex">
            <div id="td">
                <p>Đồng hồ thạch anh cho Nam giới</p>
            </div>
            ...
            <div id="nd">
                ...
                <?php
      $query=" SELECT * FROM sanpham where Loai='tanam'  ";
                ...
                <div class='modal-body' >
                    <div class='row'>
                        ...
                        <div class='col-sm-6'>
                            ...
                            <br>
                            <a id='btncart' class='btn btn-danger' data-toggle='modal' href='#'>Thêm vào giỏ hàng</a>
