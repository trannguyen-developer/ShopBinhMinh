...
?>
            ...
            <div id="cart"><a href="link/gio_hang/index.php"><img src="images/cart.png" width="60px"></a></div>
        </div>
    ...
    <div id="menu">
        <ul>
            ...
            <li><a href="link/baiviet.php">Bài viết</a></li>
            <li><a href="link/lienhe.php">Liên hệ</a></li>
        </ul>
        ...
        <div class='modal-dialog modal-lg' style='width:1200px'>
            <div class='modal-content' >
                ...
                <div class='modal-body' >
                    <div class='row'>
                        <div class='col-sm-6'>
                            <img src='../../images2/Tong/".$row['MaSP'].".jpg' width='280' >
                        </div>
                        <div class='col-sm-6'>
                            ...
                            <br>
                            <form method='POST' action='link/gio_hang/xuly_giohang.php?id=".$row['MaSP']."'>
                            <button id='btncart' class='btn btn-danger'  data-toggle='modal' name='them'>Thêm vào giỏ hàng</button>
                            </form>
                            <style>
