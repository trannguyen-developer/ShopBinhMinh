...
<section class="login-block">
    ...
    <div class="row">
        <div class="col-md-4 login-sec">
            <h2 class="text-center">Đăng nhập quyền Admin</h2> 
  ...
  <div class="form-group">
    ...
    <button type="submit" class="btn btn-login float-right" name='sub'>Đăng nhập</button>
  </div>
  
</form>
<div class="copy-text">Created with <i class="fa fa-heart"></i> by <a href="https://github.com/trannguyen-developer">trannguyen-developer</a></div>
        </div>
